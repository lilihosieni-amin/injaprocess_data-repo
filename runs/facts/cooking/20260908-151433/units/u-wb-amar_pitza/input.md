...
S-rec-bfd214478b63 · «موجودی اول شب» · amar_pitza__s1 (naharkhoran)، pitza__s1 (chalebagh)
    fields: c_a=روز[number]، c_b=ماه[string]، c_c=سال[number]، c_d=وزن پنیر پیتزا ##1[number]، c_e=وزن گوشت رست بیف ##2[number]، c_f=وزن ژامبون سه گانه ##3[number]، c_g=وزن پپرونی ##4[number]، c_h=وزن مرغ پیتزا ##5[number]، c_i=وزن گوشت چرخ کرده ##6[number]، c_j=کباب ترکی ##7[number]، c_k=وزن استیک ##8[number]، c_l=وزن فیلادلفیا ##9[number]، c_m=سوسیس کراکف ##25[string]
    header notes: —
    row labels: —
S-rec-f10f9a5c2eaa · «موجودی آخر شب» · amar_pitza__s4 (naharkhoran)، pitza__s2 (chalebagh)
    fields: c_a=روز[number]، c_b=ماه[string]، c_c=سال[number]، c_d=وزن پنیر پیتزا ##1[number]، c_e=وزن گوشت رست بیف ##2[number]، c_f=وزن ژامبون سه گانه ##3[number]، c_g=وزن پپرونی ##4[number]، c_h=وزن مرغ پیتزا ##5[number]، c_i=وزن گوشت چرخ کرده ##6[number]، c_j=کباب ترکی ##7[number]، c_k=وزن استیک ##8[number]، c_l=وزن فیلادلفیا ##9[number]، c_m=سوسیس کراکف ##25[string]، c_n=سس گوجه کف پیتزا ##33[string]، c_o=خمیر پیتزا ##26[string]
    header notes: —
    row labels: —
