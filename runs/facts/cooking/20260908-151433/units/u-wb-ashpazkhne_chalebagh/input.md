# u-wb-ashpazkhne_chalebagh

نوع: workbook — 6 نامزد تصمیم

## نامزدها

S-r-345a7b88667e · «تاریخ» · 1 variant · 6 bindings · params: p1، p2، p3
    p1 → 2025
    p2 → 12
    p3 → 16
    DATE(#,#,#)
S-rec-1ce20a4c9a9a · «زمان تحویل و سنجش کیفیت» · ashpazkhne_chalebagh__s1 (chalebagh)، ashpazkhne_naharkhoran__s1 (naharkhoran)
    fields: c_a=تاریخ[number]، c_b=سنجش کیفیت[string]، c_c=زمان تحویل سفارشات به واحد ارسال[string]
    header notes: —
    row labels: —
S-rec-56332d3ae472 · «نیازمندیها و مشکلات» · ashpazkhne_chalebagh__s4 (chalebagh)، ashpazkhne_naharkhoran__s4 (naharkhoran)
    fields: c_a=تاریخ[number]، c_b=نیازمندیها و مشکلات[string]، c_c=توضیحات و راه حل ها[string]
    header notes: —
    row labels: —
S-rec-8a136070d6a1 · «OFF اجرایی» · ashpazkhne_chalebagh__s3 (chalebagh)، ashpazkhne_naharkhoran__s3 (naharkhoran)
    fields: c_a=تاریخ[number]، c_b=تعداد از نظر هدف[number]، c_c=تعداد نفر کسب شده[number]، c_d=توضیحات[string]
    header notes: —
    row labels: —
S-rec-91d33a7a601c · «ضایعات» · ashpazkhne_chalebagh__s2 (chalebagh)، ashpazkhne_naharkhoran__s2 (naharkhoran)
    fields: c_a=تاریخ[number]، c_b=نام[string]، c_c=تعداد[number]، c_d=علت ضایعات[string]
    header notes: —
    row labels: —
S-rec-b831bf99eb37 · «خمیر» · ashpazkhne_chalebagh__s5 (chalebagh)
    fields: c_a=تاریخ[number]، c_b=تعداد آمریکایی[number]، c_c=تعداد ایتالیایی[number]، c_d=تعداد سینگل[number]
    header notes: —
    row labels: —
...
note_tab · نیازمندیها و مشکلات! · 45806.0 | شل بودن شلف پیتزا | نضافت کلی
note_tab · نیازمندیها و مشکلات! · 45807.0 | شلنگ سرخکن عوض شود  | کولر تمیز کردیم
note_tab · نیازمندیها و مشکلات! · 45809.0 | سرخ کن نیاز به تعمییر
note_tab · نیازمندیها و مشکلات! · 45814.0 | پک های بزرگ خیلی پارگی و خرابی دارند
note_tab · نیازمندیها و مشکلات! · تاریخ | نیازمندیها و مشکلات | توضیحات و راه حل ها
note_tab · نیازمندیها و مشکلات! · 45998.0 | سه راه برق سیمی  قلمو رنگ برای نظافت خمیر پهن کن سینی استیل لبه دار برای داخل سرد خانه 
note_tab · نیازمندیها و مشکلات! · 46001.0 | تعویض چرخ یخچال کوکا بعلت شکستن 
note_tab · نیازمندیها و مشکلات! · 46002.0
