...
نوع: workbook — 12 نامزد تصمیم

## نامزدها

S-rec-00a1c269f6e5 · «پیتزا ایتالیایی» · mavade_avalie__s2 (—)
    fields: c_a=نام[string]، c_b=پنیر پیتزا ##1[number]، c_c=گوشت رست بیف ##2[number]، c_d=ژامبون سه گانه ##3[number]، c_e=پپرونی ##4[number]، c_f=مرغ پیتزا ##5[number]، c_g=گوشت چرخ کرده ##6[number]، c_h=استیک ##8[number]، c_i=فیلادلفیا ##9[number]، c_j=تعداد مینی برگر ##10[number]، c_k=سوسیس کراکف ##25[number]، c_l=خمیر پیتزا ##26[number]، c_m=فلفل دلمه میکس ##31[number]، c_n=قارچ اسلایس شده ##32[number]، c_o=سس گوجه کف ##33[number]، c_p=سس رست بیف ##36[number]، c_q=سس الفردو پیتزا ##37[number]، c_r=زیتون سیاه ##30[number]، c_s=تعداد مینی مک ##43[number]، c_t=جعفری ##45[number]، c_u=کارتن ایتالیایی ##54[number]، c_v=سینگل مربع ایتالیایی ##59[number]، c_w=سه پایه پیتزا ##63[number]
    header notes: —
    row labels: r10=فیلادلفیا #552، r11=رما آلفردو #553، r12=مکزیکانو #13، r13=مخصوص #768، r14=مخصوص #771، r2=اینجا پیتزا #61، r3=پیتزا استیک #62، r4=پیتزا چهارفصل #63، r5=پیتزا کاپری چیوسا #310، r6=پیتزا ناپولی #87، r7=پیتزا چیکن باربیکیو #73، r8=میکس #49، r9=سبزیجات #551
S-rec-0f92162ffcfc · «پرسنلی» · mavade_avalie__s12 (—)
    fields: c_a=نام[string]، c_b=ژامبون سه گانه ##3[number]، c_c=پنیر پیتزا ##1[number]، c_d=خمیر پیتزا ##26[number]
    header notes: —
    row labels: r2=پیتزا پرسنلی #10
S-rec-24886a08d4ab · «پاستا» · mavade_avalie__s6 (—)
    fields: c_a=نام[string]، c_b=مرغ فرنگی ##12[number]، c_c=پنیر پارمیسان ##13[number]، c_d=قارچ فرنگی ##40[number]، c_e=پاستا پنه خام ##44[number]، c_f=جعفری ##45[number]
    header notes: —
    row labels: r2=پاستا پستو #601، r3=پاستا پنه مرغ #82
S-rec-3ac3b278cadf · «استیک» · mavade_avalie__s11 (—)
    fields: c_a=نام[string]، c_b=مرغ فرنگی ##12[number]، c_c=پرس دورچین استیک ##48[number]
    header notes: —
    row labels: r2=چیکن استیک #81
S-rec-58512a0deeb4 · «پیتزا امریکایی» · mavade_avalie__s1 (—)
    fields: c_a=نام[string]، c_b=پنیر پیتزا ##1[number]، c_c=گوشت رست بیف ##2[number]، c_d=ژامبون سه گانه ##3[number]، c_e=پپرونی ##4[number]، c_f=مرغ پیتزا ##5[number]، c_g=گوشت چرخ کرده ##6[number]، c_h=کباب ترکی ##7[number]، c_i=سوسیس کراکف ##25[number]، c_j=خمیر پیتزا ##26[number]، c_k=فلفل دلمه میکس ##31[number]، c_l=قارچ اسلایس شده ##32[number]، c_m=سس گوجه کف ##33[number]، c_n=سس کف رست بیف ##36[number]، c_o=سس الفردو پیتزا ##37[number]، c_p=زیتون سیاه ##30[number]، c_q=جعفری ##45[number]، c_r=سه پایه پیتزا ##63[number]، c_s=کارتن امریکایی ##55[number]
    header notes: —
    row labels: r10=میت #27، r11=کراکف #766، r12=مخصوص #767، r13=مخصوص #1، r2=رستبیف #71، r3=تگزاس #309، r4=مخلوط #74، r5=چیکن آلفردو #65، r6=یونانی #76، r7=پپرونی #75، r8=بیکن #308، r9=دونر #400
S-rec-6f06c2309913 · «ساندویچ» · mavade_avalie__s7 (—)
    fields: c_a=نام[string]، c_b=تعداد برگر ##14[number]، c_c=تعداد بیکن ساندویچ ##15[number]، c_d=تعداد هات داگ ##16[number]، c_e=تعداد فیله مرغ سوخاری ##17[number]، c_f=تعداد فیله مرغ سوخاری تند ##18[number]، c_g=تعداد سینه مرغ سوخاری ##19[number]، c_h=مرغ فرنگی ##12[number]، c_i=گوشت رستبیف فرنگی ##11[number]، c_j=پنیر پیتزا میکس[number]، c_k=قارچ فرنگی ##40[number]، c_l=تعداد نان مک ##41[number]، c_m=تعداد نان باگت ##42[number]، c_n=تعداد پنیر گودا پنیر گودا فرنگی ##69[number]
    header notes: —
    row labels: r10=گریل چیکن #137، r11=دبل دان #44، r12=دبل کینگ #150، r13=برگر مخصوص #773، r14=برگر مخصوص #769، r2=اینجا برگر #131، r3=ماشروم برگر #133، r4=چیز برگر #132، r5=برگر کلاسیک #138، r6=دبل برگر #134، r7=هات داگ #139، r8=ساندویچ رستبیف #136، r9=زینگرپلاس #151
S-rec-87b94d2711a8 · «سوخاری» · mavade_avalie__s8 (—)
    fields: c_a=نام[string]، c_b=تعداد فیله مرغ سوخاری ##17[number]، c_c=تعداد فیله مرغ سوخاری تند ##18[number]، c_d=تعداد سینه مرغ سوخاری ##19[number]، c_e=تعداد بال و کتف ##20[number]، c_f=سالاد کنتاکی##46[number]، c_g=تعداد مینی مک کانتر ##47[number]، c_h=قارچ سوخاری ##39[number]، c_i=جعبه سوخاری ##53[number]، c_j=جعبه سیب و قارچ ##52[number]، c_k=ظرف سالاد کنتاکی ##60[number]
    header notes: —
    row labels: r2=فیله استریپس سه تکه #385، r3=فیله استریپس چهار تکه #120، r4=فیله اسپایسی سه تکه #386، r5=فیله اسپایسی چهار تکه #350، r6=بال و کتف سوخاری #122، r7=کریسپی سینه دو تکه #123، r8=قارچ سوخاری #5
S-rec-bf477559ad68 · «پیتزا سینگل» · mavade_avalie__s3 (—)
    fields: c_a=نام[string]، c_b=پنیر پیتزا ##1[number]، c_c=گوشت رست بیف ##2[number]، c_d=ژامبون سه گانه ##3[number]، c_e=پپرونی ##4[number]، c_f=مرغ پیتزا ##5[number]، c_g=گوشت چرخ کرده ##6[number]، c_h=کباب ترکی ##7[number]، c_i=سوسیس کراکف ##25[number]، c_j=خمیر پیتزا ##26[number]، c_k=فلفل دلمه میکس ##31[number]، c_l=قارچ اسلایس شده ##32[number]، c_m=سس گوجه کف ##33[number]، c_n=سس کف رست بیف ##36[number]، c_o=سس الفردو پیتزا ##37[number]، c_p=زیتون سیاه ##30[number]، c_q=جعفری ##45[number]، c_r=کارتن امریکایی ##55[number]، c_s=سه پایه پیتزا ##63[number]
    header notes: —
    row labels: r2=رستبیف #4، r3=میت #780، r4=چیکن آلفردو #783، r5=مخصوص #782، r6=پپرونی #781، r7=کراکف #784
S-rec-d8a25df7d5be · «سالاد» · mavade_avalie__s9 (—)
    fields: c_a=نام[string]، c_b=مرغ فرنگی ##12[number]، c_c=پنیر پارمیسان ##13[number]، c_d=تعداد پرس مرغ رول سوخاری ##21[number]، c_e=کاهو پاک شده ##27[number]، c_f=روغن زیتون ##28[number]، c_g=گوجه گیلاسی ##29[number]، c_h=زیتون سیاه ##30[number]، c_i=تعداد پنیر رول سوخاری ##38[number]
    header notes: —
    row labels: r2=سالاد سزار #401، r3=سالاد چیزا #402، r4=سالاد چیزا با پنیر اضافه #407
S-rec-ddf68f27bc5d · «فرنگی» · mavade_avalie__s5 (—)
    fields: c_a=نام[string]، c_b=گوشت رستبیف فرنگی ##11[number]، c_c=مرغ فرنگی ##12[number]، c_d=پنیر پیتزا میکس[number]، c_e=قارچ فرنگی ##40[number]
    header notes: —
    row labels: r2=بیف استراگانف #86، r3=چیکن استراگانف #303
S-rec-ecd3c0bb1713 · «لازانیا» · mavade_avalie__s4 (—)
    fields: c_a=نام[string]، c_b=گوشت چرخ کرده ##6[number]، c_c=گوشت رست بیف ##2[number]، c_d=پنیر پیتزا ##1[number]، c_e=سس گوجه کف ##33[number]، c_f=قارچ اسلایس شده ##32[number]، c_g=فلفل دلمه میکس ##31[number]، c_h=زیتون سیاه ##30[number]
    header notes: —
    row labels: r2=لازانیا بلونز #85، r3=لازانیا رست بیف #84
S-rec-f344ac88fcd5 · «استارتر» · mavade_avalie__s10 (—)
    fields: c_a=نام[string]، c_b=پنیر پیتزا ##1[number]، c_c=ژامبون مرغ و گوشت میکس ##22[number]، c_d=گوشت چرخ کرده فرنگی ##23[number]، c_e=تعداد لقمه مرغ سوخاری ##24[number]، c_f=خمیر پیتزا ##26[number]، c_g=قارچ سوخاری ##39[number]، c_h=قارچ فرنگی ##40[number]، c_i=تعداد مینی مک کانتر ##47[number]، c_j=سالاد کنتاکی##46[number]، c_k=جعبه سیب و قارچ ##52[number]، c_l=جعبه سوخاری ##53[number]، c_m=کارتن امریکایی ##55[number]، c_n=ظرف سالاد کنتاکی ##60[number]، c_o=سه پایه پیتزا ##63[number]، c_p=پنیر گودا لیوانی ##74[number]
    header notes: —
    row labels: r2=سیب زمینی ویژه #27، r3=اینجا باکس #7، r4=نان سیر پیتزایی #360، r5=سیب پنیر #504، r6=مینی مک #348، r7=سالاد کنتاکی #338، r8=سیب سرخ شده #11
...
cooking-024 · cooking-024-n035 · سرخ کردن پروتئین سالاد چیزا و تحویل آن به لاین فرنگی
cooking-025 · cooking-025-n039 · تست کردن نان پروتان لاین فرنگی در فر پیتزا و تحویل آن
cooking-025 · cooking-025-n044 · تأمین رست‌بیف برای ساندویچ لاین فرنگی در شعبه ناهارخوران
cooking-026 · cooking-026-n017 · خلالی ریز کردن گوجه برای سالاد ساندویچ
cooking-026 · cooking-026-n021 · ریختن سالاد آماده ساندویچ در تاپینگ جدا
cooking-026 · cooking-026-n065 · باز کردن نان ساندویچ و ریختن سالاد آماده روی نان
cooking-026 · cooking-026-n091 · زدن پنه، پاستا یا چیکن‌استیک در ماهیتابه طبق فیش
cooking-026 · cooking-026-n100 · آماده‌سازی مواد اولیه لاین گریل، سالاد و فرنگی
cooking-026 · cooking-026-n104 · تفکیک فیش گریل و ساندویچ از فیش فرنگی روی دو فیش‌گیر مجزا
...
cooking-027 · cooking-027-n016 · تحویل کاغذ کف پیتزا (سینگل) به بخش پیتزا
cooking-027 · cooking-027-n030 · اعلام درخواست آیتم‌های سالن به لاین فرنگی یک تا دو دقیقه پیش از آماده شدن پیتزا
cooking-028 · cooking-028-n007 · خلالی ریز کردن گوجه برای سالاد ساندویچ
cooking-028 · cooking-028-n010 · آماده‌سازی سالاد ساندویچ و ریختن آن در تاپینگ جدا
cooking-028 · cooking-028-n011 · ریختن سالاد آماده ساندویچ در تاپینگ جدا
cooking-029 · cooking-029-n015 · زدن پنه، پاستا یا چیکن‌استیک در ماهیتابه طبق فیش
cooking-029 · cooking-029-n030 · ریختن سالاد آماده داخل ساندویچ روی نان
cooking-029 · cooking-029-n040 · ریختن سیب آماده تحویل‌گرفته از بخش سوخاری در ظرف پاستا
cooking-031 · cooking-031-n016 · اعلام چیکن‌استیک سالن به لاین فرنگی برای تکمیل در لحظه
