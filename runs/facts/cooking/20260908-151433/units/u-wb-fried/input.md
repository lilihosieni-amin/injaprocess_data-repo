...
S-rec-5d323801cf94 · «موجودی آخر شب» · fried__s2 (naharkhoran)، sokhari__s2 (chalebagh)
    fields: c_a=روز[number]، c_b=ماه[string]، c_c=سال[number]، c_d=تعداد پرس مرغ رول سوخاری ##21[number]، c_e=تعداد سینه مرغ سوخاری ##19[number]، c_f=تعداد فیله مرغ سوخاری ##17[number]، c_g=تعداد فیله مرغ سوخاری تند ##18[number]، c_h=تعداد بال و کتف ##20[number]، c_i=تعداد لقمه مرغ سوخاری ##24[number]، c_j=پنیر چیزا ##38[string]، c_k=قارچ سوخاری ##39[string]
    header notes: —
    row labels: —
S-rec-a1440cef3fb8 · «موجودی اول شب» · fried__s1 (naharkhoran)، sokhari__s1 (chalebagh)
    fields: c_a=روز[number]، c_b=ماه[string]، c_c=سال[number]، c_d=تعداد پرس مرغ رول سوخاری ##21[number]، c_e=تعداد سینه مرغ سوخاری ##19[number]، c_f=تعداد فیله مرغ سوخاری ##17[number]، c_g=تعداد فیله مرغ سوخاری تند ##18[number]، c_h=تعداد بال و کتف ##20[number]، c_i=تعداد لقمه مرغ سوخاری ##24[number]، c_e=تعداد ):: که ووسینه مرغ سوخاری ##19[number]
    header notes: —
    row labels: —
