...
S-rec-1e279ee0f636 · «موجودی آخر شب» · amar_kanter__s2 (naharkhoran)، kanter__s3 (chalebagh)
    fields: c_a=روز[number]، c_b=ماه[string]، c_c=سال[number]، c_d=نوشابه قوطی مشکی ##101[number]، c_e=نوشابه قوطی پرتقالی ##102[number]، c_f=نوشابه قوطی اسپرایت ##104[number]، c_g=نوشابه قوطی رژیمی ##108[number]، c_h=دوغ سون کاله ##110[number]، c_i=دوغ قوطی خوشگوار ##752[number]، c_j=نوشابه خانواده مشکی ##277[number]، c_k=نوشابه خانواده پرتقالی ##112[number]، c_l=نوشابه خانواده سون آپ ##358[number]، c_m=نوشابه خانواده زیرو ##374[number]، c_n=آب معدنی ##273[number]، c_o=دلستر استوایی ##368[number]، c_p=دلستر لیمو ##754[number]، c_q=لیموناد خوشگوار ##757[number]، c_r=وزن سالاد کنتاکی ##46[string]، c_s=تعداد مینی مک ##47[string]، c_t=وزن جعفری ##45[string]
    header notes: —
    row labels: —
S-rec-2bd7d3188cb6 · «موجودی اول شب» · amar_kanter__s1 (naharkhoran)، kanter__s1 (chalebagh)
    fields: c_a=روز[number]، c_b=ماه[string]، c_c=سال[number]، c_d=نوشابه قوطی مشکی ##101[number]، c_e=نوشابه قوطی پرتقالی ##102[number]، c_f=نوشابه قوطی اسپرایت ##104[number]، c_g=نوشابه قوطی رژیمی ##108[number]، c_h=دوغ سون کاله ##110[number]، c_i=دوغ قوطی خوشگوار ##752[number]، c_j=نوشابه خانواده مشکی ##277[number]، c_k=نوشابه خانواده پرتقالی ##112[number]، c_l=نوشابه خانواده سون آپ ##358[number]، c_m=نوشابه خانواده زیرو ##374[number]، c_n=آب معدنی ##273[number]، c_o=دلستر استوایی ##368[number]، c_p=دلستر لیمو ##754[number]، c_q=لیموناد خوشگوار ##757[number]
    header notes: —
    row labels: —
...
comment · موجودی اول شب!F37 · 149
comment · موجودی آخر شب!D36 · 149
